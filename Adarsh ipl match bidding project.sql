...
-- 1. Show the percentage of lost of each bidder in the order of highest to lowest 
-- percentage.

select bidder_id, 
round((count(if(bid_status='lost',1,null))/count(BIDDER_ID))*100,2) as lost_Percentage
